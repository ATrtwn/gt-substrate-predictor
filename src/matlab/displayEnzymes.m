function varargout = displayEnzymes(varargin)
% DISPLAYENZYMES M-file for displayEnzymes.fig
%      DISPLAYENZYMES, by itself, creates a new DISPLAYENZYMES or raises the existing
%      singleton*.
%
%      H = DISPLAYENZYMES returns the handle to a new DISPLAYENZYMES or the handle to
%      the existing singleton*.
%
%      DISPLAYENZYMES('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DISPLAYENZYMES.M with the given input arguments.
%
%      DISPLAYENZYMES('Property','Value',...) creates a new DISPLAYENZYMES or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before displayEnzymes_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to displayEnzymes_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help displayEnzymes
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @displayEnzymes_OpeningFcn, ...
                   'gui_OutputFcn',  @displayEnzymes_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before displayEnzymes is made visible.
function displayEnzymes_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to displayEnzymes (see VARARGIN)
        ...
        % Choose default command line output for displayEnzymes
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes displayEnzymes wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = displayEnzymes_OutputFcn(hObject, eventdata, handles) 
